 ...
 */
class Version20161113144951 extends AbstractMigration
{
    /**
     * @param Schema $schema
     */
    public function up(Schema $schema)
    {
        ...
        $this->addSql('ALTER TABLE tag ADD updated_at DATETIME DEFAULT NULL, CHANGE createdat created_at DATETIME NOT NULL');
    }
    ...
    public function down(Schema $schema)
    {
        ...
        $this->addSql('ALTER TABLE tag DROP updated_at, CHANGE created_at createdAt DATETIME NOT NULL');
    }
}
